...
const Register = () => {
  ...
  const { loading, user, setUser, createUser, updateUserProfile, signInWithGoogle } = useAuth()
  ...
  return (
    <div className='my-12 flex justify-center items-center min-h-[calc(100vh-306px)]'>
      <div className='flex w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-lg  lg:max-w-4xl '>
        ...
        <div
          ...
          style={{
            backgroundImage: `url('https://i.postimg.cc/c4nVHNXC/register.jpg')`,
          }}
        ></div>
      </div>
    </div>
